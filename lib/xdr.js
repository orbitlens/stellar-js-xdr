...
class XdrType {
  ...
  toXDR() {
    ...
    if (this instanceof XdrPrimitiveType) return this.constructor.toXDR(this, format);
  ...
  fromXDR(input) {
    ...
    if (this instanceof XdrPrimitiveType) return this.constructor.fromXDR(input, format);
