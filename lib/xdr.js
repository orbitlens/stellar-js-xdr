...
class ArrayReference extends _reference__WEBPACK_IMPORTED_MODULE_1__.Reference {
  constructor(childReference, length) {
    let variable = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    super();
...
class Hyper extends _xdr_type__WEBPACK_IMPORTED_MODULE_0__.XdrPrimitiveType {
  constructor(low, high) {
    super();
    if (typeof low === 'bigint') {
      if (low < MIN_VALUE || low > MAX_VALUE) throw new TypeError('Invalid i64 value');
      this._value = low;
    } else {
      if ((low | 0) !== low || (high | 0) !== high) throw new TypeError('Invalid i64 value');
  ...
  static fromString(string) {
    if (!/^-?\d{0,19}$/.test(string)) throw new TypeError(`Invalid i64 string value: ${string}`);
  ...
  constructor(source) {
    if (!(source instanceof Buffer)) {
      if (source instanceof Array) {
        ...
        throw new _errors__WEBPACK_IMPORTED_MODULE_0__.XdrReaderError('source not specified');
      }
    }
    this._buffer = source;
...
class String extends _xdr_type__WEBPACK_IMPORTED_MODULE_1__.XdrCompositeType {
  constructor() {
    let maxLength = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _unsigned_int__WEBPACK_IMPORTED_MODULE_0__.UnsignedInt.MAX_VALUE;
    super();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Array": () => (/* reexport safe */ _array__WEBPACK_IMPORTED_MODULE_11__.Array),
/* harmony export */   "Bool": () => (/* reexport safe */ _bool__WEBPACK_IMPORTED_MODULE_7__.Bool),
/* harmony export */   "Double": () => (/* reexport safe */ _double__WEBPACK_IMPORTED_MODULE_5__.Double),
/* harmony export */   "Enum": () => (/* reexport safe */ _enum__WEBPACK_IMPORTED_MODULE_15__.Enum),
/* harmony export */   "Float": () => (/* reexport safe */ _float__WEBPACK_IMPORTED_MODULE_4__.Float),
...
/* harmony export */   "Opaque": () => (/* reexport safe */ _opaque__WEBPACK_IMPORTED_MODULE_9__.Opaque),
/* harmony export */   "Option": () => (/* reexport safe */ _option__WEBPACK_IMPORTED_MODULE_13__.Option),
/* harmony export */   "Quadruple": () => (/* reexport safe */ _quadruple__WEBPACK_IMPORTED_MODULE_6__.Quadruple),
/* harmony export */   "String": () => (/* reexport safe */ _string__WEBPACK_IMPORTED_MODULE_8__.String),
/* harmony export */   "Struct": () => (/* reexport safe */ _struct__WEBPACK_IMPORTED_MODULE_16__.Struct),
/* harmony export */   "Union": () => (/* reexport safe */ _union__WEBPACK_IMPORTED_MODULE_17__.Union),
...
/* harmony export */   "VarArray": () => (/* reexport safe */ _var_array__WEBPACK_IMPORTED_MODULE_12__.VarArray),
/* harmony export */   "VarOpaque": () => (/* reexport safe */ _var_opaque__WEBPACK_IMPORTED_MODULE_10__.VarOpaque),
/* harmony export */   "Void": () => (/* reexport safe */ _void__WEBPACK_IMPORTED_MODULE_14__.Void)
/* harmony export */ });
/* harmony import */ var _int__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./int */ "./src/int.js");
...
/* harmony import */ var _float__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./float */ "./src/float.js");
/* harmony import */ var _double__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./double */ "./src/double.js");
/* harmony import */ var _quadruple__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./quadruple */ "./src/quadruple.js");
/* harmony import */ var _bool__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./bool */ "./src/bool.js");
/* harmony import */ var _string__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./string */ "./src/string.js");
/* harmony import */ var _opaque__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./opaque */ "./src/opaque.js");
/* harmony import */ var _var_opaque__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./var-opaque */ "./src/var-opaque.js");
/* harmony import */ var _array__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./array */ "./src/array.js");
/* harmony import */ var _var_array__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./var-array */ "./src/var-array.js");
/* harmony import */ var _option__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./option */ "./src/option.js");
/* harmony import */ var _void__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./void */ "./src/void.js");
/* harmony import */ var _enum__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./enum */ "./src/enum.js");
/* harmony import */ var _struct__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./struct */ "./src/struct.js");
/* harmony import */ var _union__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./union */ "./src/union.js");
...
class Union extends _xdr_type__WEBPACK_IMPORTED_MODULE_2__.XdrCompositeType {
  ...
  get() {
    let armName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._arm;
   ...
   */
  static write(value, writer) {
    if (!(value instanceof this)) throw new _errors__WEBPACK_IMPORTED_MODULE_3__.XdrWriterError(`${value} is not a ${this.unionName}`);
...
class UnsignedHyper extends _xdr_type__WEBPACK_IMPORTED_MODULE_0__.XdrPrimitiveType {
  constructor(low, high) {
    super();
    if (typeof low === 'bigint') {
      if (low < MIN_VALUE || low > MAX_VALUE) throw new TypeError('Invalid u64 value');
      this._value = low;
    } else {
      if ((low | 0) !== low || (high | 0) !== high) throw new TypeError('Invalid u64 value');
      this._value = BigInt(high >>> 0) << 32n | BigInt(low >>> 0);
    }
  }
  get low() {
   ...
   */
  static write(value, writer) {
    if (!(value instanceof this)) throw new _errors__WEBPACK_IMPORTED_MODULE_1__.XdrWriterError(`${value} is not an UnsignedHyper`);
   ...
   */
  static fromString(string) {
    if (!/^\d{0,20}$/.test(string)) throw new TypeError(`Invalid u64 string value: ${string}`);
...
class VarArray extends _xdr_type__WEBPACK_IMPORTED_MODULE_1__.XdrCompositeType {
  constructor(childType) {
    let maxLength = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _unsigned_int__WEBPACK_IMPORTED_MODULE_0__.UnsignedInt.MAX_VALUE;
    super();
    this._childType = childType;
    this._maxLength = maxLength;
  }
...
class XdrType {
   ...
   */
  toXDR() {
    let format = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'raw';
  ...
  static fromXDR(input) {
    ...
    switch (format) {
      ...
      case 'base64':
        ...
        break;
      default:
        throw new _errors__WEBPACK_IMPORTED_MODULE_2__.XdrReaderError(`invalid format ${format}, must be "raw", "hex", "base64"`);
    }
    const reader = new _serialization_xdr_reader__WEBPACK_IMPORTED_MODULE_0__.XdrReader(buffer);
    const result = this.read(reader);
    if (!reader.eof) throw new _errors__WEBPACK_IMPORTED_MODULE_2__.XdrReaderError(`invalid XDR contract typecast - source buffer not entirely consumed`);
    return result;
  }
